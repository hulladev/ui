...
export async function createShikiCodeHighlighter({ languages }: ShikiCodeHighlighterOptions) {
  ...
  return {
    highlight(code: string, { language }: ShikiHighlightOptions): HighlightedCode {
