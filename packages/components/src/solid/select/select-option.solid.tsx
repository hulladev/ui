  ...
  return (
    ...
    >
      ...
      <span
        ...
        class="ml-auto flex size-4 shrink-0 items-center justify-center text-primary opacity-0 transition-opacity duration-100 group-data-[selected]/select-option:opacity-100 motion-reduce:transition-none"
      >
