...
export type SidebarGroupTriggerProps = ComponentPropsWithRef<"summary">

export function SidebarGroupTrigger({ children, className, ...props }: SidebarGroupTriggerProps) {
  return (
    <summary
      {...props}
