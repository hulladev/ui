...
export function plainHighlightedCode(code: string, language = "text"): HighlightedCode {
  return tokensToHighlightedCode(code, language, [{ content: code }])
}

export function includesLine(lines: readonly number[] | undefined, line: number): boolean {
