  ...
  return (
    ...
    >
      ...
      <span
        ...
        class="ml-auto flex size-4 shrink-0 items-center justify-center text-primary-text opacity-0 transition-opacity duration-100 group-data-[selected]/combobox-option:opacity-100 motion-reduce:transition-none"
      >
